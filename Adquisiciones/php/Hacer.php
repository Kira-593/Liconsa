...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'undo_signature') {
    ...
    $update_query = "UPDATE c_resumenadquisiciones SET firma_usuario = '', fecha_firma = NULL = '' WHERE id = $ID";
    
    if (mysqli_query($link, $update_query)) {
        echo "<script>alert('Firma deshacha correctamente. El formulario está listo para editar.'); window.location.href = 'actualizar.php?id=$ID';</script>";
    } else {
...
<body>
    <div class="contenedor">
        ...
        <a href="Modificación.php" class="btn">Regresar a Actualizar Otro Formulario</a><br>
        <!-- El home link regresa al menú de modificación -->
        <br><a href='AdquisicionesP.php'><img src='../imagenes/home.png' height='100' width='90' alt='Volver al menú de modificación'></a>
    </div>
</body>
</html>
