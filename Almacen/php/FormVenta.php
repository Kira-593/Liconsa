        ...
        <div class="registro-container">
            <div class="registro-column">
                ...
                <div>
                    ...
                    <input type="text" id="DescripcionTD" name="DescripcionTD" placeholder="Ej.Leche Descremada UHT" required>
                </div>
                 <div>
                    <label for="CantidadITC">Cantidad Inicial:</label>
                    <input type="number" id="CantidadITC" name="CantidadITC" placeholder="Cajas" required>
                </div>
                <div>
                    <label for="CantidadETC">Cantidad de Entradas:</label>
                    <input type="number" id="CantidadETC" name="CantidadETC" placeholder="Cajas" required>
                </div>
                <div>
                    <label for="CantidadCTC">Cantidad de Cajas vendidas:</label>
                    <input type="number" id="CantidadCTC" name="CantidadCTC" placeholder="Cajas" required>
                </div>
                 <div>
                    <label for="CantidadFTC">Cantidad Final:</label>
                    <input type="number" id="CantidadFTC" name="CantidadFTC" placeholder="Cajas" required>
                </div>
            </div>
             </div>
