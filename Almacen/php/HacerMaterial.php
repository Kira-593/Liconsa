...
// 2. Consulta para actualizar los datos en la tabla 'a_existenciasmaterial'
    ...
    <div class="contenedor">
        <?php
            ...
            if (mysqli_affected_rows($link) > 0) {
                // Mensaje actualizado para Materiales
                echo "<div class='mensaje correcto'>Actualización de Existencia de Materiales correcta</div>";
            } else {
