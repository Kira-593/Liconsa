...
<main class="container">
    ...
    <section class="registro">  
        ...
        <form action="HacerVenta.php?action=hacer" method="POST" class="needs-validation" id='formulario'>
            ...
            <div class="registro-container">
                <div class="registro-column">
                    ...
                    <div>
                        ...
                        <input type="text" id="DescripcionTD" name="DescripcionTD" value="<?= $row['DescripcionTD'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Ej. Leche Descremada UHT" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="CantidadITC" name="CantidadITC" value="<?= $row['CantidadITC'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Cajas" required step="any">
                    </div>
                    <div>
                        <label for="CantidadETC">Cantidad de Entradas:</label>
                        <input type="number" id="CantidadETC" name="CantidadETC" value="<?= $row['CantidadETC'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Cajas" required step="any">
                    </div>
                    <div>
                        <label for="CantidadCTC">Cantidad de Cajas vendidas:</label>
                        <input type="number" id="CantidadCTC" name="CantidadCTC" value="<?= $row['CantidadCTC'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Cajas" required step="any">
                    </div>
                    <div>
                        <label for="CantidadFTC">Cantidad Final:</label>
                        <input type="number" id="CantidadFTC" name="CantidadFTC" value="<?= $row['CantidadFTC'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Cajas" required step="any">
                    </div>
                </div>
            </div>
           ...
           <div class="form-buttons">
                ...
                <?php else: ?>
                    ...
                    <?php if ($es_admin && $formulario_firmado): ?>
                        <form method="POST" action="HacerVenta.php" style="display:inline;">
