<?php
	...
	$query="select * from c_captacionleche";
...
<body>
    <div class="contenedor">
        ...
        <form method="get" action="actualizarRCT.php">
            <select name="sc" required>
                <?php
                    ...
                    echo "<option value='" . $fila['id'] . "' class='$color_clase'>" . 
                         $fila['id'] . " .- " . $fila['FechaDictamen'] . $estado . "</option>";
                }
                include "Cerrar.php";
                ?>
            </select>
            <input type="submit" name="elec" value="Modificar">
        </form>
