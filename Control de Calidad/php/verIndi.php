...
<head>
    <meta charset='UTF-8'>
    <title>Información de Indicadores de Control de Calidad</title>
...
<body>
    ...
    <div class='contenedor'>
        ...
        <section class='registro'>
            ...
            <div class='seccion-titulo'>🔧 Calibración Externa de los Equipos del Laboratorio</div>
            <table class='info-tabla'>
                <tr><td>Número de Equipos Atendidos:</td><td>{$row['NumEquiposAtendidos']}</td></tr>
                <tr><td>Número de Equipos Programados:</td><td>{$row['NumEquiposProgramados']}</td></tr>
                <tr><td>Calibración de Equipos:</td><td>{$row['CalibracionEquipos']}%</td></tr>
                <tr><td>Meta Esperada:</td><td>{$row['MetaEsperadaCEE']}</td></tr>
                <tr><td>Rango de Aceptación:</td><td>{$row['RangoAceptCEE']}</td></tr>
                <tr><td>Tendencia Deseada:</td><td>{$row['TendenciaDeseadaCEE']}</td></tr>
            </table>
            
            <div class='seccion-titulo'>🏭 Inspección de Áreas de Producción, Almacén y Control de Calidad</div>
            <table class='info-tabla'>
                <tr><td>Número de Observaciones:</td><td>{$row['NumObservaciones']}</td></tr>
                <tr><td>Número de Puntos Evaluados:</td><td>{$row['NumPuntosEvaluados']}</td></tr>
                <tr><td>Cumplimiento de los Puntos Evaluados:</td><td>{$row['CumplimientoPuntosEvaluados']}%</td></tr>
                <tr><td>Meta Esperada:</td><td>{$row['MetaEsperadaIAP']}</td></tr>
                <tr><td>Rango de Aceptación:</td><td>{$row['RangoAceptIAP']}</td></tr>
                <tr><td>Tendencia Deseada:</td><td>{$row['TendenciaDeseadaIAP']}</td></tr>
            </table>
            ...
            <div class='permisos-botones'>
                <form method='post' action='GestionarPermisos.php' style='display:inline;'>
                    ...
                    <input type='hidden' name='tabla' value='c_indicador'>
            ...
            <div class='links'>
                <a href='ConIndicadorC.php' class='btn btn-primary'>Realizar Otra Consulta</a>
