...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tabla = isset($_POST['tabla']) ? $_POST['tabla'] : 'i_indicador';
    ...
    $paginas_retorno = [
        'i_indicador' => 'verIndi.php'
    ];

    $pagina_retorno = isset($paginas_retorno[$tabla]) ? $paginas_retorno[$tabla] : 'InformaticaP.php';
