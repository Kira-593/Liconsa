    ...
    <section class="registro">
        ...
        <div class="registro-container">
            ...
            <div class="registro-column">
                ...
                <div>
                    ...
                    <textarea id="ObservacionesVentas" name="ObservacionesVentas" rows="3" placeholder="Ej. Se Presenta una Utilidad por $4,927,293 Pesos al 31 del Mes" required></textarea>
                </div>
        ...
        <div class="form-buttons">
            <input type="submit" name="g" value="Guardar">
             <input type="reset" name="b" value="Limpiar" class="btn" onclick="limpiarCampos()">
        </div>
