            ...
            <div class="registro-container">
                ...
                <div class="registro-column">
                    ...
                    <div>
                        ...
                        <input type="number" id="CantidadLTF" name="CantidadLTF" placeholder="Lts" 
                               value="<?= $row['CantidadLTF'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="ImporteTF">Importe:</label>
                        <input type="number" id="ImporteTF" name="ImporteTF" placeholder="$" 
                               value="<?= $row['ImporteTF'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="PorcentajeTF">Porcentaje que Representa en la Factura:</label>
                        <input type="number" id="PorcentajeTF" name="PorcentajeTF" placeholder="%" 
                               value="<?= $row['PorcentajeTF'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="CantidadLTFR" name="CantidadLTFR" placeholder="Lts" 
                               value="<?= $row['CantidadLTFR'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="ImporteTFR">Importe:</label>
                        <input type="number" id="ImporteTFR" name="ImporteTFR" placeholder="$" 
                               value="<?= $row['ImporteTFR'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="PorcentajeTFR">Porcentaje que Representa en la Factura:</label>
                        <input type="number" id="PorcentajeTFR" name="PorcentajeTFR" placeholder="%" 
                               value="<?= $row['PorcentajeTFR'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="CantidadLTPAS" name="CantidadLTPAS" placeholder="Lts" 
                               value="<?= $row['CantidadLTPAS'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="ImporteTPAS">Importe:</label>
                        <input type="number" id="ImporteTPAS" name="ImporteTPAS" placeholder="$" 
                               value="<?= $row['ImporteTPAS'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="PorcentajeTPAS">Porcentaje que Representa en la Factura:</label>
                        <input type="number" id="PorcentajeTPAS" name="PorcentajeTPAS" placeholder="%" 
                               value="<?= $row['PorcentajeTPAS'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                </div>
                ...
                <div class="registro-column">
                    ...
                    <div>
                        ...
                        <input type="number" id="CantidadLTPC" name="CantidadLTPC" placeholder="Lts" 
                               value="<?= $row['CantidadLTPC'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="ImporteLTPC">Importe:</label>
                        <input type="number" id="ImporteLTPC" name="ImporteLTPC" placeholder="$" 
                               value="<?= $row['ImporteLTPC'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="PorcentajeLTPC">Porcentaje que Representa en la Factura:</label>
                        <input type="number" id="PorcentajeLTPC" name="PorcentajeLTPC" placeholder="%" 
                               value="<?= $row['PorcentajeLTPC'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="CantidadLTUHT" name="CantidadLTUHT" placeholder="Lts" 
                               value="<?= $row['CantidadLTUHT'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="ImporteLTUHT">Importe:</label>
                        <input type="number" id="ImporteLTUHT" name="ImporteLTUHT" placeholder="$" 
                               value="<?= $row['ImporteLTUHT'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="PorcentajeLTUHT">Porcentaje que Representa en la Factura:</label>
                        <input type="number" id="PorcentajeLTUHT" name="PorcentajeLTUHT" placeholder="%" 
                               value="<?= $row['PorcentajeLTUHT'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    
                    <div>
                        <label for="ObservacionesRes">Observaciones Resumen de Facturación:</label>
                        <textarea id="ObservacionesRes" name="ObservacionesRes" rows="3" 
                                  placeholder="Ej. La Facturación Disminuyó 5.25% al cierre del mes" required 
                                  <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?>><?= $row['ObservacionesRes'] ?? '' ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="TotalFacturadoMes" name="TotalFacturadoMes" placeholder="$" 
                               value="<?= $row['TotalFacturadoMes'] ?? '' ?>" required step="any"
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="TotalDepositosMes">Total de Depositos en el Mes:</label>
                        <input type="number" id="TotalDepositosMes" name="TotalDepositosMes" placeholder="$" 
                               value="<?= $row['TotalDepositosMes'] ?? '' ?>" required step="any"
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    
                    <div>
                        <label for="ObservacionesFacturasDepositos">Observaciones Facturas y Depositos:</label>
                        <textarea id="ObservacionesFacturasDepositos" name="ObservacionesFacturasDepositos" rows="3" 
                                  placeholder="Ej. Al cierre del Mes, Los Depositos comparados con nuestra facturación Representan un Deficit del 8.37%" required 
                ...
                <div class="registro-column">
                    ...
                    <div>
                        ...
                        <input type="number" id="SaldoTS" name="SaldoTS" placeholder="$" 
                               value="<?= $row['SaldoTS'] ?? '' ?>" required step="any"
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="SaldoPV">Saldo por Vencer:</label>
                        <input type="number" id="SaldoPV" name="SaldoPV" placeholder="$" 
                               value="<?= $row['SaldoPV'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="SaldoV">Saldo Vencido:</label>
                        <input type="number" id="SaldoV" name="SaldoV" placeholder="$" 
                               value="<?= $row['SaldoV'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="Saldotreina">Saldo a 30 días:</label>
                        <input type="number" id="Saldotreina" name="Saldotreina" placeholder="$" 
                               value="<?= $row['Saldotreina'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="Saldosesenta">Saldo a 60 días:</label>
                        <input type="number" id="Saldosesenta" name="Saldosesenta" placeholder="$" 
                               value="<?= $row['Saldosesenta'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="Saldonoventa">Saldo a 90 días:</label>
                        <input type="number" id="Saldonoventa" name="Saldonoventa" placeholder="$" 
                               value="<?= $row['Saldonoventa'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    <div>
                        <label for="Saldosecenta">Saldo a más de 90 días:</label>
                        <input type="number" id="Saldosecenta" name="Saldosecenta" placeholder="$" 
                               value="<?= $row['Saldosecenta'] ?? '' ?>" required step="any" 
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    
                    <div>
                        <label for="ObservacionesSaldos">Observaciones de los Saldos:</label>
                        <textarea id="ObservacionesSaldos" name="ObservacionesSaldos" rows="3" 
                                  placeholder="Ej. La Facturación Disminuyó 5.25% al cierre del mes" required 
                    ...
                    <div>
                        ...
                        <input type="text" id="TotalSaldo" name="TotalSaldo" placeholder="$" 
                               value="<?= $row['TotalSaldo'] ?? '' ?>" required step="any"
                               <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?>>
                    </div>
                    
                    <div>
                        <label for="ObservacionesSaldomes">Observaciones del Saldo de la Alimentación Para el Bienestar:</label>
                        <textarea id="ObservacionesSaldomes" name="ObservacionesSaldomes" rows="3" 
                                  placeholder="Ej. Alimentación Para el Bienestar al cierre del Mes Presenta un Saldo Deudor de $344,250.00" required 
