...
$ID = $_GET["sc"] ?? die("
    ...
    // Verificar permisos (coincidente con actualizarMermas.php)
                ...
                <div class="registro-column">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="DF" name="DF" value="<?= $row['DF'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?> placeholder="Litros" required step="any">
                        </div>
                        
                        <div>
                            <label for="MC">Manejo de canastilla:</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="MC" name="MC" value="<?= $row['MC'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?> placeholder="Litros" required step="any">
                        </div>

                        <div>
                            <label for="MI">De manera intencional:</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="MI" name="MI" value="<?= $row['MI'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?> placeholder="Litros" required step="any">
                        </div>
