...
<head>
    ...
    <link rel="stylesheet" href="../css/actualizarEn.css">
...
<main class="container">
    ...
    <!-- El formulario envía los datos al nuevo script HacerEnvases.php -->
        <form action="HacerEnvases.php" method="POST" class="needs-validation" id="formulario">
                ...
                <div class="registro-column">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="DF" name="DF" value="<?= $row['DF'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Litros" required step="any">
                        </div>
                        
                        <div>
                            <label for="MC">Manejo de canastilla:</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="MC" name="MC" value="<?= $row['MC'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Litros" required step="any">
                        </div>

                        <div>
                            <label for="MI">De manera intencional:</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="MI" name="MI" value="<?= $row['MI'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Litros" required step="any">
                        </div>
                        
                        <div>
                            <label for="Total">Total:</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="Total" name="Total" value="<?= $row['Total'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) && !$es_admin ? 'readonly' : '' ?> placeholder="Litros" required step="any">
                        </div>
                    </div>
                </div>
            </div>
           ...
           <div class="form-buttons">
                ...
                <?php else: ?>
                    ...
                    <?php if ($es_admin && $formulario_firmado): ?>
                        <form method="POST" action="HacerEnvases.php" style="display:inline;">
                            <input type="hidden" name="id" value="<?= $row['id'] ?>">
