                ...
                <div class="registro-column">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="Leche_FrisiaK" name="Leche_FrisiaK" value="<?= $row['Leche_FrisiaK'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?> placeholder="Kilos" required step="any">
                        </div>
                        
                        <div>
                            <label for="porcentajeTF">Total porcentaje (Frisia):</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="porcentajeTF" name="porcentajeTF" value="<?= $row['porcentajeTF'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?> placeholder="%" required step="any">
                        </div>

                        <div>
                            <label for="Leche_Abasto">Leche de Abasto:</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="Leche_Abasto" name="Leche_Abasto" value="<?= $row['Leche_Abasto'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?> placeholder="Kilos" required step="any">
                        </div>
                        
                        <div>
                            <label for="porcentajeTA">Total porcentaje (Abasto):</label>
                            <!-- Carga el valor actual de la base de datos -->
                            <input type="number" id="porcentajeTA" name="porcentajeTA" value="<?= $row['porcentajeTA'] ?? '' ?>" <?= ($solo_firma || $formulario_firmado) ? 'readonly' : '' ?> placeholder="%" required step="any">
                        </div>
                    </div>
                </div>
            </div>
