...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tabla = isset($_POST['tabla']) ? $_POST['tabla'] : 'envasado_indicador';
    ...
    $paginas_retorno = [
        'envasado_indicador' => 'verIndi.php'
    ];

    $pagina_retorno = isset($paginas_retorno[$tabla]) ? $paginas_retorno[$tabla] : 'envasadoP.php';
