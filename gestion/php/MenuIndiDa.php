    ...
    <main class="container">
        <section class="menu">
            <div class="menu-column">
                ...
                <a href="IndiGestionDa.php" class="opc habilitado">
                    ...
                    <a href="ConIndicadorDa.php" class="opc habilitado">
            ...
            <div class="menu-column">
                <a href="ModIndiDa.php" class="opc habilitado">
                ...
                <?php if ($es_admin): ?>
                    <a href="BajasIndiDa.php" class="opc habilitado">
