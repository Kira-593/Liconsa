...
<head>
    ...
    <link rel="stylesheet" href="../css/gestionP.css">
    ...
    <main class="container">
        <section class="menu">
            <div class="menu-column">
                ...
                <a href="IndiGestionMa.php" class="opc habilitado">
                    ...
                    <a href="ConIndicadorMa.php" class="opc habilitado">
            ...
            <div class="menu-column">
                <a href="ModIndiMa.php" class="opc habilitado">
                ...
                <?php if ($es_admin): ?>
                    <a href="BajasIndiMa.php" class="opc habilitado">
        ...
        <br>
        <a href="Indigestiones.php" class="btn btn-danger">Menú principal</a>
    </main>
