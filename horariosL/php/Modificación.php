...
<img src="../Imagenes/logo.png" class="logo">
    ...
    <div class="contenedor">
        <h1>MODIFICACIÓN DE LA INFORMACIÓN DE LOS HORARIOS</h1>
        <p>Seleccione el ID del horario que quiere modificar.</p>
        
        <form method="get" action="actualizar.php">
            <label for="sc">ID del Horario:</label>
        ...
        <a href="horarioP.php"><img src="..\imagenes\home.png" alt="Inicio" height="100" width="90"></a>
    </div>
</body>
</html>
