	...
	<main class="container">
		<section class="menu">
			<div class="menu-column">
				...
				<a href= "Asignacion.php" class="opc">
					<img src="../imagenes/asignacion.png" height="70" width="80" align="left" class="icono">
					<span>ASIGNACIÓN DE HORARIOS</span>
				</a>
            ...
            <a href= "Modificación.php" class="opc">
					...
					<span>MODIFICACIÓN DE HORARIOS</span>
				</a>
                
				<a href= "Bajas.php" class="opc">
					<img src="../imagenes/eliminar.png" height="70" width="80" align="left" class="icono">
					<span>ELIMINACIÓN DE HORARIOS</span>
				</a>

				<a href= "ModifiAsig.php" class="opc">
					<img src="../imagenes/editar.png" height="70" width="80" align="left" class="icono">
