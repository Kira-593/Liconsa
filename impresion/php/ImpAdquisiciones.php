...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/Adquisiciones.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/Adquisiciones.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: ADQUISICIONES DE BIENES MUEBLES Y SERVICIOS</span>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="6" class="font-7">
                <span class="text-bold">Fuente de Información:</span> '.$fila["ObservacionesRes"].'
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Cumplimiento de las compras <br>compras realizadas</td>
            <td class="font-6">
                Expedientes completos atendidos / expendientes completos recibidos * 100<br><br>
                '.$fila["ExpAtend"].'<br>
                ─────  × 100 = <b>'.$fila["Cumplimiento"].'%</b><br>
                '.$fila["ExpRecib"].'
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaCCR"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptCCR"].'%</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaCCR"].'&</td>
        </tr>
        
        <!-- FILA 2 -->
        <tr>
            <td class="text-center font-7">2</td>
            <td class="text-center font-6-5">Satisfacción al cliente</td>
            <td class="font-6">
                Encuestas satisfactorias / número de encuestas enviadas en el semestre * 100<br><br>
                '.$fila["EncuSatisfa"].'<br>
                ─────────  × 100 = <b>'.$fila["Satisfaccion"].'%</b><br>
                '.$fila["EncEnvia"].'
                <br>
    
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaSC"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptSC"].'%</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaSC"].'%</td>
        </tr>
