...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/Almacen.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/Almacen.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: HOJA DE PROCESO DE ALMACEN</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">SATISFACCIÓN DE NUESTROS<br>CLIENTES</td>
            <td class="font-6">
                Sumatoria de la calificación de encuesta de satisfacción de nuestros clientes/El numero de encuestas<br><br>
                '.$fila["SumEn"].'<br>
                ─────  = '.$fila["PuntosSatisfaccion"].'<br>
                '.$fila["NumEncuestas"].'
            </td>
