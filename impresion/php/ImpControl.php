...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/ControlC.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/ControlC.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento:CONTROL DE CALIDAD</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Calibración externa de los<br>equipos de laboratorio</td>
            <td class="font-6">
                Número de equipos atendidos / número de equipos programados * 100<br><br>
                '.$fila["NumEquiposAtendidos"].'<br>
                ─────  × 100 = <b>'.$fila["CalibracionEquipos"].'%</b><br>
                '.$fila["NumEquiposProgramados"].'
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaCEE"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptCEE"].'%</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaCEE"].'</td>
        </tr>
        
        <!-- FILA 2 -->
        <tr>
            <td class="text-center font-7">2</td>
            <td class="text-center font-6-5">Inspección de áreas de<br>producción, almacén y<br>control de calidad en la<br>gerencia estatal Tlaxcala</td>
            <td class="font-6">
                Número de puntos evaluados - número de observaciones / Número de puntos evaluados<br><br>
                '.$fila["NumObservaciones"].'<br>
                ─────────  × 100 = <b>'.$fila["CumplimientoPuntosEvaluados"].'%</b><br>
                '.$fila["NumPuntosEvaluados"].'
                <br>
    
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaIAP"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptIAP"].'%</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaIAP"].'</td>
        </tr>
