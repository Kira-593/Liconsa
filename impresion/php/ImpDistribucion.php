...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/Distribucion.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/Distribucion.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: P-6 Distribución/span>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="6" class="font-7">
                <span class="text-bold">Fuente de Información:</span> '.$fila["Observ"].'
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Cumplimiento con el despacho programado<br></td>
            <td class="font-6">
                Dotación real/ Dotación requerida * 100 =<br><br>
                '.$fila["CumplRealProgDia"].'<br>
                ─────  × 100 = <b>'.$fila["PCDP"].'%</b><br>
                '.$fila["ProgDiarioDespacho"].'
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaMB"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptMB"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaMB"].'</td>
        </tr>
        
        <!-- FILA 2 -->
        <tr>
            <td class="text-center font-7">2</td>
            <td class="text-center font-6-5">Cumplimiento de ventas programadas</td>
            <td class="font-6">
                Venta total / Dotación real × 100 = <br><br>
                '.$fila["Ventatot"].'<br>
                ───────── x 100= <b>'.$fila["CumplimientoVentas"].'%</b><br>
                '.$fila["DotEntre"].'
                <br>
    
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaCVP"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptCVP"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaCVP"].'</td>
        </tr>
        
        <!-- FILA 3 -->
        <tr>
            <td class="text-center font-7">3</td>
            <td class="text-center font-6-5">Control de envases rotos imputables al transportista</td>
            <td class="font-6">
                Mermas / Dotación Real × 100<br><br>
                '.$fila["MermasEnva"].'<br>
                ──────/ x 100 = <b>'.$fila["CantidadEnvRotos"].'</b><br>
                '.$fila["DotEnva"].' 
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaCER"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptCER"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaCER"].'</td>
        </tr>
        
        <!-- FILA 4 -->
        <tr>
            <td class="text-center font-7">4</td>
            <td class="text-center font-6-5">Devoluciones</td>
            <td class="font-6">
                Devoluciones / Dotación Real × 100<br><br>
                '.$fila["Devoluciones"].'<br>
                ───── × 100 = <b>'.$fila["DevolucionesDPAS"].'</b><br>
                '.$fila["DotDev"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaDPAS"].'</td>
                <td class="text-center font-6-5">'.$fila["RangoAceptDPAS"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaDPAS"].'</td>
        </tr>
        
        <!-- FILA 5 -->
        <tr>
            <td class="text-center font-7">5</td>
            <td class="text-center font-6-5">Gastos de Distribución Anual</td>
            <td class="font-6">
                Gastos totales de distribución / Litros distribuidos<br><br>
                '.$fila["GastosTD"].'<br>
                ───── = <b>'.$fila["GastosDistribucion"].'</b><br>
                '.$fila["LitrosDistribucion"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaGD"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptGD"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaGD"].'</td>
        </tr>
