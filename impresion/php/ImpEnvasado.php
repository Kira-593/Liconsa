...
try {
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: ENVASADO</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Calidad de leche reconstituida (volumen) abasto y frisia</td>
            <td class="font-6">
                Reporte mensual de control de calidad de la leche<br> pasturizada abasto<br><b>'.$fila["RepAbasto"].'</b><br>
                Reporte mensual de control de calidad de la leche<br> pasturizada frisia<br><b>'.$fila["RepFrisia"].'</b><br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaMB"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAcept"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaMB"].'</td>
        </tr>
        
        <!-- FILA 2 -->
        <tr>
            <td class="text-center font-7">&nbsp;</td>
            <td class="text-center font-6-5">&nbsp;</td>
            <td class="font-6" style="min-height: 60px;">&nbsp;</td>
            <td class="text-center font-7">&nbsp;</td>
            <td class="text-center font-6-5">&nbsp;</td>
            <td class="text-center font-6">&nbsp;</td>
        </tr>
