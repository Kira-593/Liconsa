...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/SeH.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/SeH.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: GESTION DEL AMBIENTE DE TRABAJO Y COMPETENCIAS DE PERSONAL (SEGURIDAD E HIGIENE)</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Ambiente de trabajo "reporte de inspección <br> de orden de seguridad y limpieza en áreas<br> de servicio"</td>
            <td class="font-6">
                No. de satisfacciones / No. puntos * 100<br><br>
                '.$fila["NoSatis"].'<br>
                ─────  × 100 = <b>'.$fila["DndSat"].'%</b><br>
                '.$fila["NoPuntos"].'
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaRIO"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptRIO"].'%</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaRIO"].'</td>
        </tr>
        
        <!-- FILA 2 -->
        <tr>
            <td class="text-center font-7">5</td>
            <td class="text-center font-6-5">Ambiente de trabajo "uniformes de trabajo<br>y equipo de protección personal<br> operativo"</td>
            <td class="font-6">
                No. de satisfacciones / No.puntos * 100<br><br>
                '.$fila["NoSatisUnif"].'<br>
                ───────── × 100 = <b>'.$fila["DndSatUnif"].'%</b><br>
                '.$fila["NoPuntosUnif"].'
                <br>
    
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaUTE"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptUTE"].'%</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaUTE"].'</td>
        </tr>
        
        <!-- FILA 3 -->
        <tr>
            <td class="text-center font-7">6</td>
            <td class="text-center font-6-5">Accidentes e insidestes por riesgo del<br> trabajo</td>
            <td class="font-6">
                Frecuencia / (cantidad de accidentes / dias laborados) * 100<br><br>
                '.$fila["CantAcci"].'<br>
                ────── × 100 = <b>'.$fila["Frecuencia"].'</b><br>
                '.$fila["DiasLaborados"].'
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaAIR"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptAIR"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaAIR"].'</td>
        </tr>
        
        <!-- FILA 4 -->
        <tr>
            <td class="text-center font-7">7</td>
            <td class="text-center font-6-5">Actos y condiciones inseguras</td>
            <td class="font-6">
                Actos y/o condiciones inseguras repotadas en<br>el mes:<br><br>
                <b>'.$fila["CantActCondInseg"].'</b><br>
                
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaACI"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptACI"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaACI"].'</td>
        </tr>
