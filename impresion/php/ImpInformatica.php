...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/Informatica.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/Informatica.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: APOYO A LA INFRESTRUCTURA INFORMÁTICA</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Solicitud de servicio</td>
            <td class="font-6">
                Atender las solicitudes generadas por el usuario<br>total de solicitudes atendidas / total de solicitudes generadas<br>por el usuario * 100<br><br>
                '.$fila["SolicitudesAtendidas"].'<br>
                ─────  × 100 = <b>'.$fila["PorSolicitudesAtendidas"].'%</b><br>
                '.$fila["NumSolicitudes"].'
                <br>
                Se presenta: <b>'.$fila["EventualidadesMes"]. '</b> eventualidades en el mes
            </td>
