...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/Mantenimiento.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/Mantenimiento.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: Mantenimiento, instalaciones y equipo de planta</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Gastos de operación</td>
            <td class="font-6">
                El presupuesto ejercido < ó = al gasto autorizado<br><br>
                '.$fila["PresEje"].' < ó = '.$fila["GastoAutorizado"].' diferencia = <b>'.$fila["Diferiencia"].'</b><br>
               
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaGO"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptGO"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaGO"].'</td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Disponibilidad del equipo<br>para la producción<br>pasteurizado<br>envasado<br>rehidratado</td>
            <td class="font-6">
                Total (horas hombres disponible - horas de paro) / total de horas disponibles * 100<br><br>
                '.$fila["HorasHombre"].' - '.$fila["HorasParo"].'<br>
                ─────────  × 100 = <b>'.$fila["prc"].'%</b><br>
                '.$fila["HorasDisponibles"].'

                <br><br>
                '.$fila["HorasHombreEnv"].' - '.$fila["HorasParoEnv"].'<br>
                ─────────  × 100 = <b>'.$fila["prcEnv"].'%</b><br>
                '.$fila["HorasDisponiblesEnv"].'

                <br><br>
                '.$fila["HorasHombreReh"].' - '.$fila["HorasParoReh"].'<br>
                ─────────  × 100 = <b>'.$fila["prcReh"].'%</b><br>
                '.$fila["HorasDisponiblesReh"].'

                <br>
    
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaDEP"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptDEP"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaDEP"].'</td>
        </tr>
        
        <!-- FILA 3 -->
        <tr>
            <td class="text-center font-7">3</td>
            <td class="text-center font-6-5">Trabajos Preventivos<br>Global Polvo</td>
            <td class="font-6">
                Trabajos Programados Ejecutados / Trabajos Programados × 100<br><br>
                '.$fila["TPE"].'<br>
                ────── x 100 = <b>'.$fila["PorcentTP"].'%</b><br>
                '.$fila["TP"].' 
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaTP"].'%</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptTP"].'%</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaTP"].'%</td>
        </tr>
        
        <!-- FILA 4 -->
        <tr>
            <td class="text-center font-7">4</td>
            <td class="text-center font-6-5">Trabajos Correctivos</td>
            <td class="font-6">
                Trabajos correctivos / Trabajos Programados × 100<br><br>
                '.$fila["TC"].'<br>
                ───── × 100 = <b>'.$fila["PorcentTC"].'%</b><br>
                '.$fila["TP"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaTC"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptTC"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaTC"].'</td>
        </tr>
        
        <!-- FILA 5 -->
        <tr>
            <td class="text-center font-7">5</td>
            <td class="text-center font-6-5">Consumo Térmmico</td>
            <td class="font-6">
                Consumo térmico / Litros de leche producida<br><br>
                '.$fila["ConsumoTermico"].'<br>
                ─────  = <b>'.$fila["ConsTT"].' Energia</b><br>
                '.$fila["LitrosLecheProducidatermica"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaCT"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptCT"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaCT"].'</td>
        </tr>
        <!-- FILA 6 -->
        <tr>
            <td class="text-center font-7">6</td>
            <td class="text-center font-6-5">Consumo de Agua</td>
            <td class="font-6">
                Consumo de agua / Litros de leche producida<br><br>
                '.$fila["ConsumoAgua"].'<br>
                ─────  = <b>'.$fila["ConsTA"].' Lts</b><br>
                '.$fila["LitrosLecheProducida"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaCA"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptCA"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaCA"].'</td>
        </tr>
       <!-- FILA 7 -->
        <tr>
            <td class="text-center font-7">7</td>
            <td class="text-center font-6-5">Consumo Eléctrico</td>
            <td class="font-6">
                Consumo eléctrico / Litros de leche producida<br><br>
                '.$fila["ConsumoElectrico"].'<br>
                ─────  = <b>'.$fila["ConsTE"].' Kw</b><br>
                '.$fila["LitrosLecheProducidaElectrico"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaCE"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptCE"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaCE"].'</td>
        </tr>
       </table>
       <table style="page-break-inside: avoid; border: none;">
        ...
        <tr>
            ...
            <td colspan="2.5" class="no-border text-center font-8" style="padding-top:15px;">
               <br><br> <br> <br><br>   _________________<br>
