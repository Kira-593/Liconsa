...
try {
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: ADMINISTRACIÓN DEL PADRÓN DE BENEFICIARIOS</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Meta de<br>Beneficiarios</td>
            <td class="font-6">
                Número de Beneficiarios / Meta de Beneficiarios<br><br>
                '.$fila["NumBenefi"].'<br>
                ─────  × 100 = <b>'.$fila["MetaReal"].'</b><br>
                '.$fila["MetaBeneficiarios"].'
            </td>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Factor de Retiro<br>Global Líquida</td>
            <td class="font-6">
                litros vendidos / número de beneficiarios activos × días de venta<br><br>
                '.$fila["LitrosVendidos"].'<br>
                ─────────/'.$fila["DiasVenta"].'= <b>'.$fila["FacRetLi"].'</b><br>
                '.$fila["NumBenefiActivos"].'
                <br>
    
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaFRL"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptFRL"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaFRL"].'</td>
        </tr>
        
        <!-- FILA 3 -->
        <tr>
            <td class="text-center font-7">3</td>
            <td class="text-center font-6-5">Factor de Retiro<br>Global Polvo</td>
            <td class="font-6">
                litros vendidos / número de beneficiarios activos × días de venta<br><br>
                '.$fila["LitrosVendidosPol"].'<br>
                ──────/ '.$fila["DiasVentaPol"].' = <b>'.$fila["FacRetPol"].'</b><br>
                '.$fila["NumBenefiActivosPol"].' 
                <br>
            </td>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Tarjetas No<br>Entregadas</td>
            <td class="font-6">
                Tarjetas no entregadas / Número de Familias Inscritas en el Padrón × 100<br><br>
                '.$fila["TNE"].'<br>
                ───── × 100 = <b>'.$fila["PorcentajeTNE"].'</b><br>
                '.$fila["FamiliasInscritas"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaTNE"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptTNE"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaTNE"].'</td>
        </tr>
        
        <!-- FILA 5 -->
        <tr>
            <td class="text-center font-7">5</td>
            <td class="text-center font-6-5">Atención a<br>Quejas</td>
            <td class="font-6">
                Quejas recibidas / Quejas atendidas × 100<br><br>
                '.$fila["QuejasRecibidas"].'<br>
                ─────  × 100 = <b>'.$fila["PQNA"].'</b><br>
                '.$fila["QuejasAtendidas"].'<br>
                <br>
            </td>
            <td class="text-center font-7">'.$fila["MetaEsperadaAQ"].'</td>
            <td class="text-center font-6-5">'.$fila["RangoAceptAQ"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaAQ"].'</td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">'.$fila["RangoAceptES"].'</td>
            <td class="text-center font-6">'.$fila["TendenciaDeseadaES"].'</td>
        </tr>
        <!-- FIRMA -->
        <tr class="no-border">
        </tr>
