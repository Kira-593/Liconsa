...
try {
    ...
    if (isset($fila['firma_usuario']) && !empty($fila['firma_usuario']) && trim($fila['firma_usuario']) !== '') {
        ...
        $rutaFirmaRelativa = '../Imagenes/firmas/Recursos.JPG';
        $rutaFirmaAbsoluta = __DIR__ . '/../Imagenes/firmas/Recursos.JPG';
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
        ...
        <tr style="border-bottom: none;">
            ...
            <span class="text-bold">Proceso y/o Procedimiento: RECURSOS FINANCIEROS</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-center font-6-5">Suficiencia Presupuestal</td>
            <td class="font-6">
                Número de expedientes de suficiencia presupuestal autorizados * 100 / número de expedientes <br>de suficiencia presupuestal recividos<br><br>
                '.$fila["ExpedinAut"].' × 100<br>
                ───────────────  = <b>'.$fila["PorcentajeExpAut"].'%</b><br>
                '.$fila["ExpendiReci"].'
