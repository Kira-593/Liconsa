<?php
    ...
    $query = "INSERT INTO p_rutasdistribucion (
        Mes, LitrosTRuno, PorcentajeTRuno, LitrosTRdos, PorcentajeTRdos, LitrosTRtres, PorcentajeTRtres, LitrosTRcuatro, PorcentajeTRcuatro
    ) VALUES (
        '$Mes', '$LitrosTRuno', '$PorcentajeTRuno', '$LitrosTRdos', '$PorcentajeTRdos', '$LitrosTRtres', '$PorcentajeTRtres', '$LitrosTRcuatro', '$PorcentajeTRcuatro'
    )";
...
<body>
    <div class="contenedor">
        <?php
            ...
            include "Cerrar.php";
        ?>
        <br><a href='FormRutas.php' class='btn'>Realizar Otra Inserción</a><br>
