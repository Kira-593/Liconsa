...
<html lang="es">
<head>
    <title>Administración del Padrón de Beneficiarios</title> 
    <meta charset="UTF-8">
...
<main class="container">
    ...
    <h1>Indicadores</h1>
    <h4>Administración del Padrón de Beneficiarios</h4>
    ...
    <section class="registro">
        ...
        <div class="registro-container">
            ...
            <div class="registro-column">
                ...
                <h4>Meta de Beneficiarios</h4>
                
                <div>
                    <label for="NumBenefi">Número de Beneficiarios:</label>
                ...
                <div>
                    ...
                    <input type="text" id="RangoAceptMB" name="RangoAceptMB" placeholder="Ej. Cumplimiento del 93% al 99%" required>
                </div>
                
                <div>
                    <label for="TendenciaDeseadaMB">Tendencia Deseada:</label>
                    <input type="text" id="TendenciaDeseadaMB" name="TendenciaDeseadaMB" placeholder="Ej. Cumplimiento al 100%" required>
                </div>
                
                <hr>
                
                <h4>Factor de Retiro Global Líquida</h4>
                ...
                <div>
                    <label for="FacRetLi">Factor de retiro Global Líquida:</label>
                ...
                <div>
                    ...
                    <input type="text" id="MetaEsperadaFRL" name="MetaEsperadaFRL" placeholder="La meta esperada es:" required>
                </div>
            ...
            <div class="registro-column">
                ...
                <h4>Factor de Retiro Global Polvo</h4>
                ...
                <div>
                    <label for="DiasVentaPol">Días de Venta:</label>
                ...
                <div>
                    ...
                    <input type="text" id="MetaEsperadaFRP" name="MetaEsperadaFRP" placeholder="La meta esperada es:" required>
                </div>
                ...
                <div>
                    <label for="FamiliasInscritas">Número de Familias Inscritas en el Padrón:</label>
                ...
                <div>
                    ...
                    <input type="text" id="MetaEsperadaTNE" name="MetaEsperadaTNE" placeholder="La meta esperada es:" required>
                </div>
            ...
            <div class="registro-column">
                ...
                <!-- SECCIONES ADICIONALES - AGREGADAS PARA COINCIDIR CON ACTUALIZACIÓN -->
                
                <h4>Atención a Quejas</h4>
                ...
                <div>
                    ...
                    <input type="text" id="MetaEsperadaAQ" name="MetaEsperadaAQ" placeholder="La meta esperada es:" required>
                </div>
                ...
                <div>
                    <label for="MaxPuntos">Máximo de puntos:</label>
                ...
                <div>
                    ...
                    <input type="text" id="MetaEsperadaES" name="MetaEsperadaES" placeholder="La meta esperada es:" required>
                </div>
                ...
                <div>
                    ...
                    <textarea id="Fuente" name="Fuente" rows="3" placeholder="Ej. La Facturación Disminuyó 5.25% al cierre del mes" required></textarea>
                </div>
            </div>
