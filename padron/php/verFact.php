<?php
    ...
    $query = "SELECT * FROM p_factorretiro WHERE id = '$Mes'";
   ...
   echo "
       <!DOCTYPE html>
        ...
        <head>
            <meta charset='UTF-8'>
            <title>Información del Factor de Retiro</title>
        ...
        <body>
            ...
            <h1>Información del Factor de Retiro</h1>
            <hr>
            <section class='registro'>
                ...
                <tr><td colspan='2'><strong>Cantidades Mensuales</strong></td></tr>
                <tr><td>Factor de Retiro Mínimo:</td><td>{$row['FactorRTF']}</td></tr>
                <tr><td>Alcance del Mes:</td><td>{$row['AlcanceTA']}</td></tr>
                ...
                <hr>
                <div class='links'>
                    <a href='ConFact.php' class='btn'>Realizar Otra Consulta</a>
                ...
                <form method='post' action='GestionarPermisos.php' style='display:inline;'>
                    ...
                    <input type='hidden' name='tabla' value='p_factorretiro'>
