...
$query = "UPDATE ruta SET
			RU_IN='$Origen', RU_FIN='$Destino', CA_DNI ='$DNI'
		  WHERE ID_RU='$ID'";
...
<body>
	<div class="contenedor">
		<?php
			...
			include "Cerrar.php";
		?>
	    <a href="Modificación.php" class="btn">Regresar a Actualizar Otra Ruta</a><br>
		<br><a href='rutasP.php'><img src='..\imagenes\home.png' height='100' width='90'></a>
	</div>
</body>
</html>