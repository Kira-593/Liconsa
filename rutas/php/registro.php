...
<main class="container">
        ...
        <div class="registro-container">
            <div class="registro-column">
                ...
                <div>
                    ...
                    <input type="text" id="Origen" name="Origen" maxlength="45" placeholder="Puebla" required>
                </div>
                <div>
                    <label for="Destino">Destino:</label>
                    <input type="text" id="Destino" name="Destino" maxlength="45" placeholder="Tlaxcala" required>
                </div>
                <div>
    ...
    <a href="rutasP.php" class="home-link">
